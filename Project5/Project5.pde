...
void setup()
{
  ...
  //testing
  testText = loadShape("models/text.obj");
  testText.setFill(color(255,255,255));

  // TODO: Load scene files here (testfile, scene 1, and scene 2)
  Scene scene1 = new Scene("scenes/scene1.txt");
  Scene scene2 = new Scene("scenes/scene2.txt");
...
void draw()
{
  ...
  // testing
  pushMatrix();
  pointLight(200, 255, 200, -150, 100, 50);
  translate(-300,0,75);
  shape(testText);
  popMatrix();
